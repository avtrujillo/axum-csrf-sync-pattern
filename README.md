...
[![Dependency status](https://deps.rs/repo/github/LeoniePhiline/axum-csrf-sync-pattern/status.svg)](https://deps.rs/repo/github/LeoniePhiline/axum-csrf-sync-pattern)
